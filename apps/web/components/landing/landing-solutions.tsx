        ...
        {SOLUTIONS.map((sol) => {
          ...
          return (
            <button
              ...
              className={`p-3.5 rounded-xl text-left flex flex-col items-center sm:items-start gap-2.5 transition-all cursor-pointer ${
                isSelected
                  ? "bg-emerald-600 text-white shadow-lg shadow-emerald-500/25 ring-2 ring-emerald-500/30 scale-[1.02]"
                  : "bg-white dark:bg-slate-900/80 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200/80 dark:border-slate-800/80"
              }`}
            >
              <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 p-5 sm:p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 space-y-5">
            ...
            <div className="space-y-2 pt-2 border-t border-slate-200/70 dark:border-slate-800/70">
              ...
              <div className="flex items-center justify-between text-[11px] font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800/50 p-2.5 rounded-lg border border-slate-200/60 dark:border-slate-700/60">
