...
export interface BadgeProps extends React.HTMLAttributes<HTMLDivElement> {
  variant?: "success" | "warning" | "danger" | "info" | "neutral" | "purple" | "glow" | "outline" | "secondary" | "destructive";
  size?: "sm" | "md";
  dot?: boolean;
}
...
export function Badge({
  ...
  const variantStyles: Record<string, string> = {
    ...
    destructive: "bg-rose-500/10 text-rose-700 dark:text-rose-400 border-rose-500/30 font-semibold",
    ...
    outline: "border border-slate-200 dark:border-slate-800 bg-transparent text-slate-700 dark:text-slate-300 font-medium",
  };
